...
class LuisLinearLayoutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_luis_linear_layout)
        ...
        val btnRegresarEjercicio2 = findViewById<Button>(R.id.btnRegresarEjercicio2)

        btnRegresarEjercicio2.setOnClickListener {
            val menuEjercicio2Intent =  Intent(this, LuisEjercicio2Activity::class.java)

            register.launch(menuEjercicio2Intent)
        }
